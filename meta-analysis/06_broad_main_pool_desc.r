...
l_england_pyears[["md"]] <-
  read_csv(
    file = "england_results/p_years_broad_m.csv",
    col_types = "_ccdd",
...
l_england_pyears[["pb"]] <-
  read_csv(
    file = "england_results/p_years_broad_p.csv",
    col_types = "_ccdd",
    name_repair = make_clean_names
  ) %>% 
  select(
...
l_england_desc[["overall"]] <-
  bind_rows(
    read_csv(
      file = "england_results/cohort_desc_broad.csv",
      col_types = "_ccddd",
      name_repair = make_clean_names
    ),
    read_csv(
      file = "england_results/time_since_vacc_broad.csv",
      col_types = "_ccddd",
      name_repair = make_clean_names
    )
  )
...
l_england_desc[["md"]] <-
  bind_rows(
    read_csv(
      file = "england_results/cohort_desc_broad_m.csv",
      col_select = -1,
      col_types = "_ccddd",
      name_repair = make_clean_names
    ),
    read_csv(
      file = "england_results/time_since_vacc_broad_m.csv",
      col_select = -1,
      col_types = "_ccddd",
      name_repair = make_clean_names
    )
...
l_england_desc[["pb"]] <-
  bind_rows(
    read_csv(
      file = "england_results/cohort_desc_broad_p.csv",
      col_select = -1,
      col_types = "_ccddd",
      name_repair = make_clean_names
    ),
    read_csv(
      file = "england_results/time_since_vacc_broad_p.csv",
      col_select = -1,
      col_types = "_ccddd",
      name_repair = make_clean_names
    )
...
d_england <-
  ...
  arrange(strata != "overall", strata) %>% 
  filter(xvar != "vacc_name") %>% 
  # calc rate
  mutate(
...
d_scotland <-
  read_csv(
    file = "scotland_results/broad_hosp_death_main_desc.csv"
  ) %>% 
  rename(
    strata = vacc_group
  ) %>% 
...
l_wales <- list()
l_wales[["overall"]] <- read_csv("wales_results/broad_hosp_death_overall_desc.csv")
l_wales[["md"]]      <- read_csv("wales_results/broad_hosp_death_md_desc.csv")
l_wales[["pb"]]      <- read_csv("wales_results/broad_hosp_death_pb_desc.csv")
...
l_ni <- list()
l_ni[["overall"]] <- read_csv("northern_ireland_results/broad_hosp_death_overall_desc.csv")
l_ni[["pb"]]      <- read_csv("northern_ireland_results/broad_hosp_death_pb_desc.csv")
...
write_pretty_xlsx(
  df   = d_all,
  file = "meta_analysis_results/broad_main_t_desc_all.xlsx"
)
...
write_pretty_xlsx(
  df   = d_pool_pretty,
  file = "meta_analysis_results/broad_main_t_desc_pool.xlsx"
)
