...
```{r}
qread("../results/t_sample_selection_broad.qs") %>%
mutate(
	n = suppress_n(n),
...
```{r}
qload("../results/analyse_hosp_death_main_broad.qsm")
```
...
write_csv(
	t_hosp_death_overall_npr,
	file = "../results/broad/t_hosp_death_overall_npr.csv"
)
...
write_csv(
	t_hosp_death_md_npr,
	file = "../results/broad/t_hosp_death_md_npr.csv"
)
...
write_csv(
	t_hosp_death_pb_npr,
	file = "../results/broad/t_hosp_death_pb_npr.csv"
)
...
# coefs
write_csv(hosp_death_overall_coef_adj, file = "../results/broad/m_hosp_death_overall_coef_adj.csv")
write_csv(hosp_death_md_coef_adj,      file = "../results/broad/m_hosp_death_md_coef_adj.csv")
write_csv(hosp_death_pb_coef_adj,      file = "../results/broad/m_hosp_death_pb_coef_adj.csv")

# variance-covariance
hosp_death_overall_vcov_adj %>%
as_tibble() %>%
write_csv(file = "../results/broad/m_hosp_death_overall_vcov_adj.csv")

hosp_death_md_vcov_adj %>%
as_tibble() %>%
write_csv(file = "../results/broad/m_hosp_death_md_vcov_adj.csv")

hosp_death_pb_vcov_adj %>%
as_tibble() %>%
write_csv(file = "../results/broad/m_hosp_death_pb_vcov_adj.csv")
```
